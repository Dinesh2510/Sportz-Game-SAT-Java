package com.app.sportsappjava.Adapter;
...
import com.app.sportsappjava.databinding.ItemPlayerListBinding;
...
public class PlayerAdapter extends RecyclerView.Adapter<PlayerAdapter.MyViewHolder> {
    ...
    public PlayerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PlayerAdapter.MyViewHolder(ItemPlayerListBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
